	...
	<head>
        ...
        function modiNum(goodsId,quantity)
        {
            ...
            else
            {
				...
				$.get("/Shopping/updateCart.do",{goodsId:goodsId,count:quantity},callback());
            }
        }
        ...
        {
            document.getElementById("indicator1").style.display="block";
			$.get("/Shopping/updateCart.do?type=del",{goodsId:goodsId},callback());
        }
        
        function clearCart()
        {
            document.getElementById("indicator1").style.display="block";
            $.get("/Shopping/updateCart.do?type=clear",{},callback());
        }
    </script>
	</head>
		             ...
		             <div class="list pic_news">
	                        ...
	                        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  <td>${item.value.goods.goods_name}</td>
									  <td>￥${item.value.goods.goods_shichangjia}"<br/></td>
									  <td><input type="text" class="textBox" onChange="modiNum(${item.value.goods.goods_id},this.value)" value="${item.value.goods_quantity}" size="4"/></td>
									  <td> ￥ ${item.value.goods_quantity * item.value.goods.goods_shichangjia} </td>
									  <td> <input onClick="delGoodsFromCart(${item.value.goods.goods_id})" type="image" src="<%=path %>/images/delete_01.gif" border="0"/></td>
								  </tr>
								  </c:forEach>
					              <tr>
	        				...
	        				<table>
			                   ...
			                   <tr>
			                       ...
			                       <td><a href="<%=path %>/qiantai/order/orderQueren.jsp"><img border="0" src="<%=path %>/images/Car_icon_03.gif"/></a></td>
			                   </tr>
			               </table>
		             </div>
		         </div>	
