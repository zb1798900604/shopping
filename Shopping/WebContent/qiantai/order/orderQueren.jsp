			...
			<div class="page_main_msg left">		
		        <div class="left_row">
		            <div class="list pic_news">
						  	...
						  	<form action="<%=path %>/orderSubmit.do" name="f" method="post">
		                        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>收货人帐号：</td>
					                  <td>
					                      <input type="text" readonly="readonly" value="${sessionScope.user.user_name }"/>
					                  </td>
					              </tr>
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>收货人姓名：</td>
					                  <td>
					                      <input type="text" readonly="readonly" value="${sessionScope.user.user_realname}"/>
					                  </td>
					              </tr>
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>收货人联系电话：</td>
					                  <td>
					                      <input type="text"  value="${sessionScope.user.user_tel}"/>
					                  </td>
					              </tr>
					              
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>送货地址：</td>
					                  <td><input type="text" name="odderSonghuodizhi" value="${sessionScope.user.user_address}"/></td>
					              </tr>
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>付款方式：</td>
					                  <td>
