  ...
  <form action="<%=path%>/orderPing.do" method="post">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  ...
			  <td><img src="<%=path %>${orderItem.goods.goods_pic }" width="50px" height="50px"/>
			     
			  </td>
			  
			  <td><textarea name="txt ${orderItem.orderItem_id }" cols="25" rows="5"></textarea>
			      <input type="hidden" name="goods ${orderItem.orderItem_id }" value="${orderItem.goods.goods_id }"/>
			      <input type="hidden" name="goodsname${ orderItem.orderItem_id}" value="${orderItem.goods.goods_name }"/></td>
		  </tr>
		 </c:forEach>
		   <tr height="26">
