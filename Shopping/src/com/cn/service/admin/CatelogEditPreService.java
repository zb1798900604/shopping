...
public class CatelogEditPreService {
	public List<TCateLog> queryCatelog(int catelogId) {
		List<Map<String, Object>> list=MyDB.executeQuery("select * from t_catelog where catelog_id=?", catelogId);
